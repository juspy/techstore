                        ...
                        <div class="main__goods-icons d-flex flex-wrap">
                            <div class="main__icons-card">
                                ...
                                <div class="main__goods-descr">
                                    Hamkorlarning qulayligi uchun Toshkentda ikkita yirik omborimiz bor, ulardan biri"Malika" bozorida
                                </div>
                            </div>
                            <div class="main__icons-card">
                                <div class="main__goods-title">
                                ...
                                <div class="main__goods-descr">
                                    Biz 20 dan ortiq taniqli atrof-muhit va tarkibiy qismlarni tarqatish bilan shug'ullanamiz
                                </div>
                            </div>
                            <div class="main__icons-card">
                                <div class="main__goods-title">
                                ...
                                <div class="main__goods-descr">
                                    Katta buyurtmani qoldirib, siz doimo ishonch hosil qilishingiz mumkin biz uni o'z vaqtida bajaramiz
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="container">
                        ...
                        <div class="main__about-description">
                            <p class="main__about-description-descr">
                                2020 yilda tashkil etilgan Techstore Distribution kompaniyasi O'zbekistondagi eng yirik chakana distribyutor hisoblanadi. Kompaniyaning bosh ofisi va ombori Toshkentda, O'zbekiston poytaxtida joylashgan. Hozirgi vaqtda kompaniya kompyuter texnologiyalari, ya'ni kompyuter atrof-muhit birliklari va monitorlar sohasida tarqatmoqda.
                                Techstore faoliyatining asosiy yo'nalishi sherik kompaniyalar va tashkilotlar bilan ishlashdir. Kompaniyaning sheriklari chakana zanjirlar, alohida kichik yoki katta do'konlar, onlayn-do'konlar, kompyuter klublari va boshqalar. Techstore uchun asosiy qadriyatlar samarali hamkorlik, sheriklar bilan yaqin munosabatlar, rivojlanish yo'nalishi, qo'llab-quvvatlash va fikr-mulohazalardir.
                                Techstore taniqli brendlar va yangi yosh kompaniyalar bilan uzoq muddatli hamkorlikni o'rnatish va rivojlantirishga intiladi.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="container">
                        <div class="main__distributions-title">
                            <h2 class="main__distributions-text">
                                Techstore O'zbekistonda quyidagi brendlarni tarqatadi:
                            </h2>
                        </div>
                        <div class="row">
                        <div class="container">
                ...
                <div class="main__partners-content">
                    <div class="container">
                        ...
                        <form method="post" action="../index.php" id="form" accept-charset="utf-8" class="main__partners-form d-flex flex-column" target="_blank">
                            <input type="email" name="email1" required placeholder="Sizning E-mail">
                            <input type="text" required name="company_name" placeholder="Sizning kompaniyangiz">
                            <input type="text" required name="phone" placeholder="Sizning telefon raqami">
                            <input type="submit" class="main__partners-button" id="btn" name="submit" value="Yuborish">
                        </form>
                        </div>
                        <div class="main__partners-descr">
                            <p class="main__partners-descr-descr">
                                Shaklni to'ldiring va biz siz bilan bog'lanamiz!
                            </p>
                        </div>
            ...
            <div class="container">
                ...
                <div class="footer__text">
                    <h6 class="footer__text-about">
                        2022 ООО “Techstore”<br>Barcha huquqlar himoyalangan.
                    </h6>
                </div>
            </div>
        </div>
